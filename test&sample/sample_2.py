...
#画像の変数宣言
pic_name="sample_2"+ ".jpg"
pic_name_out="sample_2"+ "out.jpg"
gray_pic="sample_2"+"gray.jpg"
...
#ベース画像と同じ大きさの配列を作成
img_sample_2=np.zeros((height,width,3),np.uint8)

#オレンジ色を指定
img_sample_2[(h > 178) & (s > 100)& (v > 100)] = 255

#オレンジの領域だけの画像を作成
cv2.imwrite(gray_pic,np.array(img_sample_2))
